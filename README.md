...
<p align="center">
  ...
  &nbsp;
  <img src="https://img.shields.io/badge/💼 Experience-1%2B Year-22C55E?style=flat-square" />
  &nbsp;
  <img src="https://img.shields.io/badge/🏆 Debate Champion-All Over UP-FFD700?style=flat-square&labelColor=1a1a2e&color=FFD700" />
</p>
...
const utkarsh = {
  name        : "Utkarsh Singh",
  education   : "B.Tech — BBD University, Lucknow 🎓",
  role        : "Full Stack Web Developer",
  experience  : "1+ Year 🚀",
  liveProject : "https://echoesofnow.in  ← Built this from scratch!",
  instagram   : "https://instagram.com/onepiece_0x",
  ...
  stack: {
    ...
    learning  : ["Python 🐍", "Data Analytics 📊", "Vibe Coding 🎵"],
  },

  achievements : [
    "🏆 Debate Champion — All Over Uttar Pradesh",
    "🌐 Built & deployed echoesofnow.in from scratch",
  ],

  motto : "Ship fast. Debug faster. Chai in between. ☕",
};
```
...
<!-- FOOTER BANNER -->
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=12,20,24&height=130&section=footer&text=Thanks%20for%20visiting!%20Drop%20a%20%E2%AD%90%20if%20you%20like%20my%20work!&fontSize=13&fontColor=a5c8ff&animation=fadeIn" />
